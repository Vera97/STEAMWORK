<template>
    <div>
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" >
            ...
            <el-menu-item index="1">课程资源</el-menu-item>
            <el-menu-item index="2">我的成就</el-menu-item>
            <el-submenu index="3">
                <template slot="title">我的小组</template>
                <el-menu-item index="3-1">小组一</el-menu-item>
                <el-menu-item index="3-2">小组二</el-menu-item>
                <el-menu-item index="3-3">小组三</el-menu-item>
            </el-submenu>
            <el-menu-item index="4">开始听课</el-menu-item>
            <div class="login">
